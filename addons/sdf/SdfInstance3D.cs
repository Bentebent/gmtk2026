...
public partial class SdfInstance3D : Node3D {
	...
	public override void _Ready() {
		if (_sdfResource == null || SdfRegistry.Instance == null) {
			return;
		}
	...
	public byte[] GetInstanceData() {
		var rotation = new Quaternion(GlobalBasis).Normalized();
		var data = new[] {
			GlobalPosition.X,
			GlobalPosition.Y,
			GlobalPosition.Z,
	...
	public override void _Process(double delta) {
		if (_updatedResource && SdfRegistry.Instance != null) {
			if (_oldType != null) {
